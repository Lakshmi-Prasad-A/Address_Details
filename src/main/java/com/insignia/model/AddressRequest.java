...
public class AddressRequest {
	...
	public Long getCustomer_sequence_number() {
		return customer_sequence_number;
	}

	public void setCustomer_sequence_number(Long customer_sequence_number) {
		this.customer_sequence_number = customer_sequence_number;
	}
	...
	public String toString() {
		return "AddressRequest [customer_sequence_number=" + customer_sequence_number + ", addressLine1=" + addressLine1
